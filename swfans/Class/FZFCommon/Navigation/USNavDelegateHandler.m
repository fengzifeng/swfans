...
- (void)panGestureHandler:(UIPanGestureRecognizer*)recognizer
{
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (location.x <  CGRectGetMidX(view.bounds) && velocity.x > 0 && count > 1) { // left half went right
            ...
            MCViewController *topViewController = (id)_navigationController.topViewController;
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController animationControllerForOperation:(UINavigationControllerOperation)operation fromViewController:(UIViewController *)fromVC toViewController:(UIViewController *)toVC
{
    ...
    MCViewController *targetVC = (MCViewController *)(reversed?fromVC:toVC);
...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(MCViewController *)viewController animated:(BOOL)animated
{
...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    MCViewController *topVC = (id)_navigationController.topViewController;
